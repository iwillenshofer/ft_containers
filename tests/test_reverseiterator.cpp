...
/*   Updated: 2021/09/25 10:43:13 by iwillens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char *array;
	array = "Testing a String.";
	
	T tmp(array, array + 17);
...
void test_reverseiterator(ft::Tester tester)
{
	...
	tester.printTitle("Reverse Iterator");
	tester.printName("comparing ft::reverse_iterator and ft::reverse_iterator results.");
